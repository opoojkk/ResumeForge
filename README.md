...
- **多主题模板**：内置多种简历风格，可在编辑器中切换
- **模板可扩展**：支持社区通过 PR 在 `lib/templates.ts` 中新增模板（支持变量局部覆盖）
...
- 扩展入口：`lib/templates.ts`
- 模板可以只覆盖部分变量，未覆盖项自动回退默认主题
- 详细步骤见：[docs/templates.md](./docs/templates.md)
